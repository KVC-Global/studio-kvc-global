...
export const onlineProgramPage = defineType({
  ...
  fields: [
    ...
    defineField({name: 'structureSection', title: 'Program structure (numbered requirements)', type: 'onlineProgramStructure', group: 'content'}),
    defineField({name: 'whySection', title: 'Why choose', type: 'onlineProgramWhy', group: 'content'}),
    defineField({name: 'supportSection', title: 'Support list (why study via KVC)', type: 'onlineProgramSupport', group: 'content'}),
    ...
    defineField({name: 'progressionSection', title: 'Progression (further study)', type: 'onlineProgramProgression', group: 'content'}),
