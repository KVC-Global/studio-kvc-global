...
export const malaysiaStudyPage = defineType({
  name: 'malaysiaStudyPage',
  title: 'Malaysia Study Page',
  type: 'document',
  groups: [
  ...
  preview: {
    ...
    prepare({language, title}) {
      return {
        title: title || (language === 'en' ? 'Malaysia Study Page — English' : 'Trang Du học Malaysia — Tiếng Việt'),
