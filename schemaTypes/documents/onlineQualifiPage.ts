...
export const onlineQualifiPage = defineType({
  ...
  fields: [
    ...
    defineField({name: 'targetAudienceSection', title: 'Target audience (Đối tượng phù hợp)', type: 'onlineProgramAudience', group: 'content'}),
    defineField({name: 'learningFormatsSection', title: 'Learning format (Hình thức học)', type: 'onlineProgramFormat', group: 'content'}),
    ...
    defineField({name: 'programsSection', title: 'Các chương trình QUALIFI (Programs Timeline)', type: 'onlineProgramPrograms', group: 'content'}),
