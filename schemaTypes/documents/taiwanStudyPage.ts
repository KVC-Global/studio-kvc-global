...
export const taiwanStudyPage = defineType({
  name: 'taiwanStudyPage',
  title: 'Taiwan Study Page',
  type: 'document',
  groups: [
  ...
  preview: {
    ...
    prepare({language, title}) {
      return {
        title: title || (language === 'en' ? 'Taiwan Study Page — English' : 'Trang Du học Đài Loan — Tiếng Việt'),
