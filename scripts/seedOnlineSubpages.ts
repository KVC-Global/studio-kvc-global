...
const othmData = (lang: 'vi' | 'en') => {
  ...
  return {
    ...
    targetAudienceSection: {
      title: isVi ? 'Đối tượng phù hợp' : 'Target Audience',
      items: [
        { icon: 'GraduationCap', title: isVi ? 'Sinh viên' : 'Students' },
        { icon: 'Briefcase', title: isVi ? 'Người đi làm' : 'Working Professionals' },
        { icon: 'Building2', title: isVi ? 'Nhà quản lý & Chủ doanh nghiệp' : 'Managers & Business Owners' },
        { icon: 'Globe', title: isVi ? 'Người có kế hoạch du học' : 'Prospective Study Abroad Students' },
        { icon: 'Clock', title: isVi ? 'Người cần linh hoạt' : 'Learners Needing Flexibility' },
      ],
    },
    benefitsSection: {
...
const wolverhamptonData = (lang: 'vi' | 'en') => {
  ...
  return {
    ...
    targetAudienceSection: {
      title: isVi ? 'Đối tượng phù hợp' : 'Target Audience',
      items: [
        { icon: 'GraduationCap', title: isVi ? 'Người đã tốt nghiệp đại học' : 'University Graduates' },
        { icon: 'Building2', title: isVi ? 'Nhà quản lý & Lãnh đạo' : 'Managers & Leaders' },
        { icon: 'Briefcase', title: isVi ? 'Người đi làm' : 'Working Professionals' },
        { icon: 'Globe', title: isVi ? 'Học viên hướng quốc tế' : 'Globally Oriented Learners' },
        { icon: 'Clock', title: isVi ? 'Người cần linh hoạt' : 'Flexible Learners' },
      ],
    },
    benefitsSection: {
